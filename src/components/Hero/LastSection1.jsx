...
const LastSection1 = () => {
    return (
        <div className='relative sticky top-16 bg-green-800 md:h-[40vh] h-[52vh] '>
            <div className='text-xl text-white container mx-auto py-10 flex flex md:flex-row flex-col md:gap-0 md:p-0 gap-6 p-4'>
                <div>
